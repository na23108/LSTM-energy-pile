...
if mode == 1:
    ...
    for i, file in enumerate(excel_files, 1):
        ...
        df = pd.read_excel(file_path, sheet_name='data', skiprows=6, header=0, usecols=['Time', 'Outlet Temp', 'Inlet Temp']) 
    ...
    validation_split=0.1, #Use 10% of the data as validation.
    ...
    hist_path = os.path.join(hist_save_dir, f"history_{datetime.now().strftime('%Y_%m_%d_%H_%M_%S')}.csv")
