...
if mode == 1:
    ...
    model = Sequential([
        GRU(GRU_units, return_sequences=True, input_shape=(look_back, 1)),
    ...
    # 1 layer
    # model = Sequential([
    #     LSTM(GRU_units, input_shape=(look_back, 1)),  # return_sequences=False (default)
    #     Dropout(dropout_rate),
    #     Dense(2)
    #     ])
    ...
    num_gru_layers = int(input("Enter number of LSTM layers used in this run (1-5): "))
